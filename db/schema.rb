...
ActiveRecord::Schema.define(version: 2022_02_24_051247) do
  ...
  create_table "flipper_features", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "key", null: false
    t.datetime "created_at", null: false
  ...
  create_table "flipper_gates", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
  ...
  create_table "spree_fx_rates", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "spree_payment_methods_stores", id: :integer, charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "payment_method_id"
    t.bigint "store_id"
  ...
  create_table "spree_skrill_transactions", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "email"
    t.float "amount"
    t.string "currency"
  ...
  create_table "spree_taggings", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.integer "tag_id"
  ...
  create_table "spree_tags", id: :integer, charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "spree_wished_products", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "variant_id"
    t.bigint "wishlist_id"
    t.integer "quantity", default: 1, null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["variant_id", "wishlist_id"], name: "index_spree_wished_products_on_variant_id_and_wishlist_id", unique: true
  ...
  create_table "startup_wizard_checklists", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "startup_wizard_statuses", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.bigint "checklist_id", null: false
    t.bigint "store_id", null: false
    t.boolean "done", default: false, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["checklist_id", "store_id"], name: "index_startup_wizard_checklists_on_checklist_id_and_store_id", unique: true
