...
gem 'spree_clone_store', git: 'https://github.com/truehostcloud/spree-clone-store', tag: 'v1.1.5'
...
gem 'spree_flutterwave', github: 'truehostcloud/spree_flutterwave', tag: 'v1.0.0'
