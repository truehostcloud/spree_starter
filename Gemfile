...
gem 'spree_clone_store', git: 'https://github.com/truehostcloud/spree-clone-store', tag: 'v1.1.4'
...
gem 'spree_flutterwave', github: 'truehostcloud/spree_flutterwave', tag: 'v1.0.1'
gem 'spree_auth_devise'
gem 'spree_i18n', '>= 5.0'
gem 'spree_dev_tools', require: false, group: %w[test development]
gem 'spree_fx_currency', github: 'truehostcloud/spree_fx_currency', tag: 'v4.0.7'
